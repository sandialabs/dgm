...
# making conformal triangle mesh for mesh-based geometry. Side 0
cubit.cmd('reset')
cubit.cmd('import facets "box_tet_faces_side0.facet"')
...
cubit.cmd('export mesh "box_tet_faces_side0.exo" dimension 3 block 1 overwrite')
...
cubit.cmd('import mesh geometry "box_tet_faces_side0.exo" feature_angle 135  merge')
new_surf_id = cubit.get_last_id("surface")
cubit.cmd('surface ' + str(old_surf_id+1) + ' to ' + str(new_surf_id) + ' name "domain_bdy_f0"')
...
cubit.cmd('import facets "salt_surface_triangulation_0.facet" feature_angle 135  merge')
t_id_end = cubit.get_last_id("surface")
cubit.cmd('surface ' + str(t_id_begin) + ' to ' + str(t_id_end) + ' name "salt_surface_triangulation_0"')
cubit.cmd('group "g_salt_surface_triangulation_0" equals surface with name "salt_surface_triangulation_0"')

t_id_begin = cubit.get_last_id("surface") + 1
cubit.cmd('import facets "salt_surface_triangulation_1.facet" feature_angle 135  merge')
t_id_end = cubit.get_last_id("surface")
cubit.cmd('surface ' + str(t_id_begin) + ' to ' + str(t_id_end) + ' name "salt_surface_triangulation_1"')
cubit.cmd('group "g_salt_surface_triangulation_1" equals surface with name "salt_surface_triangulation_1"')

t_id_begin = cubit.get_last_id("surface") + 1
cubit.cmd('import facets "salt_surface_triangulation_2.facet" feature_angle 135  merge')
t_id_end = cubit.get_last_id("surface")
cubit.cmd('surface ' + str(t_id_begin) + ' to ' + str(t_id_end) + ' name "salt_surface_triangulation_2"')
cubit.cmd('group "g_salt_surface_triangulation_2" equals surface with name "salt_surface_triangulation_2"')
...
cubit.cmd('group "vol1" add surface in g_salt_surface_triangulation_0')
#add last bottom triangulation as top of this layer
cubit.cmd('group "vol2" add surface in g_salt_surface_triangulation_0')
if num_layers != num_layers_expected:
  print("Automatic layer assignment will fail. You must manually edit the next lines to assign vs<i> domain-side surfaces to the correct vol<j>")
  cubit.cmd('ERROR_Automatic_layer_assignment_will_fail._You_must_manually_edit_the_next_lines_to_assign_vs<i>_domain-side_surfaces_to_the_correct_vol<j>')
...
cubit.cmd('group "vol2" add surface in g_salt_surface_triangulation_1')
cubit.cmd('group "vol2" add surface in g_salt_surface_triangulation_2')
#add last bottom triangulation as top of this layer
cubit.cmd('group "vol3" add surface in g_salt_surface_triangulation_2')
if num_layers != num_layers_expected:
  print("Automatic layer assignment will fail. You must manually edit the next lines to assign vs<i> domain-side surfaces to the correct vol<j>")
  cubit.cmd('ERROR_Automatic_layer_assignment_will_fail._You_must_manually_edit_the_next_lines_to_assign_vs<i>_domain-side_surfaces_to_the_correct_vol<j>')
cubit.cmd('group "vol3" add surface in vs3')
...
cubit.cmd('group "vol4" add surface in g_salt_surface_triangulation_1')
