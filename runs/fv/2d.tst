...
Performs a finite-volume test of Reo advection-diffusion physics.'''
...
if dts.opts.baseline and not status:
  ...
  print 'WARNING:  baseline not currently implemented'
...
if dts.opts.clean and not status:
  ...
  status += dts.call('rm -f 2d.*.bin u.1000.bdt')
