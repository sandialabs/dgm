...
if dts.opts.diff and not status:
  ...
  status += dts.call('ndiff.py -a 1e-12 -r 1e-12 2d.d0.prb 2d.d0.prf')
  status += dts.call('ndiff.py -a 1e-12 -r 1e-12 2d.d1.prb 2d.d1.prf')
  status += dts.call('ndiff.py -a 1e-12 -r 1e-12 2d.g0.prb 2d.g0.prf')
  status += dts.call('ndiff.py -a 1e-12 -r 1e-12 2d.g1.prb 2d.g1.prf')
  status += dts.call('ndiff.py -a 9e-11 -r 1e-12 2d.f0.prb 2d.f0.prf')
  status += dts.call('ndiff.py -a 1e-12 -r 1e-12 2d.f1.prb 2d.f1.prf')
  status += dts.call('ndiff.py -a 1e-10 -r 1e-11 2d.f2.prb 2d.f2.prf')
