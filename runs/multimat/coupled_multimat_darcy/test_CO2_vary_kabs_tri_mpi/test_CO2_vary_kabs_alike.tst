...
root = 'test_CO2_vary_kabs_alike'     # root filename for test
aeps = 9.0e-8    # absolute error tolerance
reps = 9.0e-8    # relative error tolerance
...
if dts.opts.clean and not status:
  ...
  status += dts.call('dgm_clean test_CO2_vary_kabs_alike_darcy')
